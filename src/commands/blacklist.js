const { Interaction, MessageEmbed, Role } = require("discord.js");
    ...
    async execute(interaction) {
        ...
        switch (interaction.options.getSubcommand()) {
            ...
            case "remove": {
                ...
                if (type === "member") description.push(`They can now use the bot again.`);
                else description.push(`Members with this role can now use the bot again.`);
