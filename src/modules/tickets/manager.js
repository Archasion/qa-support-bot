...
module.exports = class TicketManager extends EventEmitter {
    ...
    async create(guild_id, creator_id, category_id, topic) {
        ...
        if (!caticket_row) throw new Error("Ticket category does not exist");
        ...
        (async () => {
            ...
            const embed = new MessageEmbed()
                ...
                .setFooter(config.text.footer, guild.iconURL());
                ...
                const collector_message = await t_channel.send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setFooter(
                                utils.footer(config.text.footer, "Expires in 120 seconds"),
                                guild.iconURL()
                            )
                    ]
                });
    ...
    async close(ticket_id, closer_id, guild_id, reason) {
        ...
        const close = async () => {
            ...
            if (closer_id) {
                ...
                var description = `This ticket has been closed by ${closer.user.toString()}.\nThe channel will be deleted in 5 seconds.`;
